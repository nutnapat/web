...
class ChaptersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post chapters_url, params: { chapter: { cartoon_id: @chapter.cartoon_id, num: @chapter.num } }
    end
  ...
  test "should update chapter" do
    patch chapter_url(@chapter), params: { chapter: { cartoon_id: @chapter.cartoon_id, num: @chapter.num } }
